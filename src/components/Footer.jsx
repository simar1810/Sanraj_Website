  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#BBD63C] via-[#03311bd8] to-[#067a42] w-full pb-2 rounded-t-xl">
      <div className="mx-6 sm:mx-10 md:mx-20 2xl:mx-40 py-10 sm:py-14 lg:py-16 relative z-10">
        ...
        {/* Form */}
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8 mb-10">
          {[
            { label: "Name", type: "text", placeholder: "Enter your name" },
            { label: "Phone", type: "text", placeholder: "Enter your phone number" },
            { label: "Email", type: "email", placeholder: "Enter your email" },
            { label: "What is your goal", type: "text", placeholder: "Enter your goal" },
        ...
        <div className="flex justify-center">
          <button className="px-8 sm:px-10 lg:px-12 py-2.5 sm:py-3 rounded-full text-white font-semibold text-base sm:text-lg bg-[#424242] shadow-md shadow-gray-600">
            Submit
          </button>
        </div>
      </div>
...
At Sanraj Wellness, we believe in empowering every individual to live a balanced, healthy, and fulfilled life. Through expert guidance, nutrition, and a supportive community, we help you achieve lasting transformation—inside and out.
          </p>
        </div>
        ...
        <div className="flex flex-col text-white items-center md:items-start justify-center text-center md:text-left">
          ...
          <p className="mb-2 md:mb-4 text-sm sm:text-base"><span className="font-bold">Email</span> : szalte111@gmail.com</p>
          <p className="mb-3 md:mb-5 text-sm sm:text-base"><span className="font-bold">Mobile No.</span> : +91 - 8888099399</p>
      ...
      <div className="mx-6 sm:mx-10 md:mx-20 2xl:mx-40 py-4 sm:py-5 border-t-2 border-[#FFFFFF6B] mt-8 sm:mt-10 flex flex-col lg:flex-row items-center justify-between text-white gap-2 lg:gap-0 relative z-10 text-xs sm:text-sm lg:text-base text-center sm:text-left">
        ...
        <p>All Rights Reserved | <span className="cursor-pointer hover:underline" onClick={()=>window.open('/terms-and-conditions', "_blank")}>Terms & Conditions</span> | <span className="hover:underline cursor-pointer" onClick={()=>window.open('/privacy-policy', "_blank")}>Privacy Policy</span></p>
      </div>
    </footer>
  );
}
